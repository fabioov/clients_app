			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"clientsapp-display": {
								"semanticObject": "clientsapp",
								"action": "display",
								"description": "Clients Fiori App",
								"title": "Clients App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=clientsapp",
									"url": sap.ui.require.toUrl("clientsapp")
								}
							}
						}
					}
